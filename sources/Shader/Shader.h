...
public:
   ...
   void Bind(std::function<void(const Shader&)> SetDynamicUniformsCallback = nullptr) const
   {
   ...
   {
      glUniform4fv(glGetUniformLocation(_idProgram, name.c_str()), 1, glm::value_ptr(value));
   }
